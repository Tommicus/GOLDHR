...
<br><br>
As mentioned above, when implementing measures to decrease the company's churn rate, one should not focus too much on the "Fresh&Happy" Segment, while being very concerned about the other two segments, which show rates close to or above 50%.
```{r echo=TRUE, tidy=TRUE}
